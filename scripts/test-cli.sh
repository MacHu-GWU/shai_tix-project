...
shai-tix search_stories --id_lower 10 --id_upper 11
echo ""

echo "--- Create tasks for search testing ---"
shai-tix create_task 10 "Write Unit Tests"
shai-tix create_task 10 "Write Integration Tests"
shai-tix create_task 10 "Fix Bug"
echo ""
...
shai-tix update_story 16 --status "TODO"
shai-tix create_story "In Progress Story"
shai-tix update_story 17 --status "IN_PROGRESS"
shai-tix create_story "Completed Story"
shai-tix update_story 18 --status "COMPLETED"
...
shai-tix create_task 16 "TODO Task One"
shai-tix update_task 20 --status "TODO"
shai-tix create_task 16 "In Progress Task"
shai-tix update_task 21 --status "IN_PROGRESS"
shai-tix create_task 16 "Completed Task"
shai-tix update_task 22 --status "COMPLETED"
shai-tix create_task 16 "TODO Task Two"
